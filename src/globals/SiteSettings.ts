...
export const SiteSettings: GlobalConfig = {
    ...
    fields: [
        ...
        // NOTE: Temporarily disabled - database columns need migration
        // These settings are configured via hardcoded defaults in get-thresholds.ts
        // TODO: Re-enable once migration is verified working
        // {
